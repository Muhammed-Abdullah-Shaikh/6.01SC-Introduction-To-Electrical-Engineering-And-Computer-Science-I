# Embedded file name: /mit/6.01/mercurial/spring11/codeSandbox/lib601/sm.py
"""
    ...
    def printDebugInfo(self, depth, state, nextState, inp, out, debugParams):
        ...
        if debugParams.verbose and not debugParams.compact:
            if debugParams.printInput:
                print(' ' * depth, self.name, 'In:', end=' ')
                print(util.prettyString(inp), end=' ')
                print('Out:', util.prettyString(out), end=' ')
...
class Cascade(SM):
    ...
    def __init__(self, m1, m2, name = None):
        ...
        if name is None or isinstance(name, str):
            print(isinstance(m1, SM) and (isinstance(m2, SM) or m1), m2, name)
...
class Parallel(SM):
    ...
    def __init__(self, m1, m2, name = None):
        ...
        self.m2 = m2
        if name is None or isinstance(name, str):
            raise isinstance(m1, SM) and (isinstance(m2, SM) or Exception)('Parallel takes two machine arguments and an optional name argument')
        self.name = name
        raise set(self.m1.legalInputs) == set(self.m2.legalInputs) or AssertionError
        self.legalInputs = self.m1.legalInputs
        return
...
class Feedback(SM):
    ...
    def __init__(self, m, name = None):
        self.m = m
        if name is None or isinstance(name, str):
            raise isinstance(m, SM) or Exception('Feedback takes one machine argument and an optional name argument')
        self.name = name
        return
    ...
    def getNextValues(self, state, inp):
        ...
        raise o != 'undefined' or AssertionError('Error in feedback; machine has no delay')
...
class FeedbackAdd(SM):
    ...
    def __init__(self, m1, m2, name = None):
        ...
        self.m2 = m2
        if name is None or isinstance(name, str):
            raise isinstance(m1, SM) and (isinstance(m2, SM) or Exception)('FeedbackAdd takes two machine arguments and an optional name argument')
        self.name = name
        return
...
class FeedbackSubtract(SM):
    ...
    def __init__(self, m1, m2, name = None):
        ...
        self.m2 = m2
        if name is None or isinstance(name, str):
            raise isinstance(m1, SM) and (isinstance(m2, SM) or Exception)('FeedbackSubtract takes two machine arguments and an optional name argument')
        self.name = name
        return
...
class If(SM):
    ...
    def __init__(self, condition, sm1, sm2, name = None):
        ...
        if name is None or isinstance(name, str):
            raise isinstance(sm1, SM) and (isinstance(sm2, SM) or Exception)('If takes a condition, two machine arguments and an optional name argument')
        self.name = name
...
class Switch(SM):
    ...
    def __init__(self, condition, sm1, sm2, name = None):
        ...
        self.condition = condition
        if name is None or isinstance(name, str):
            raise isinstance(sm1, SM) and (isinstance(sm2, SM) or Exception)('Switch takes a condition, two machine arguments and an optional name argument')
        self.name = name
        self.legalInputs = self.m1.legalInputs
        return
...
class Sequence(SM):
    ...
    def __init__(self, smList, name = None):
        ...
        self.smList = smList
        if not name is None:
            raise (not isinstance(name, str) or not isinstance(smList, (tuple, list))) and Exception('Sequence takes a list of machines and an optional name argument')
        self.n = len(smList)
        self.name = name
...
class Repeat(SM):
    ...
    def __init__(self, sm, n = None, name = None):
        ...
        self.n = n
        if name is None or isinstance(name, str):
            raise isinstance(sm, SM) or Exception('Repeast takes one machine argument, an integer, and an optional name argument')
        self.name = name
...
class RepeatUntil(SM):
    ...
    def __init__(self, condition, sm, name = None):
        ...
        self.condition = condition
        if name is None or isinstance(name, str):
            raise isinstance(sm, SM) or Exception('RepeatUntil takes a condition, a machine argument and an optional name argument')
        self.name = name
        self.legalInputs = self.sm.legalInputs
        return
...
class Until(SM):
    ...
    def __init__(self, condition, sm, name = None):
        ...
        self.condition = condition
        if name is None or isinstance(name, str):
            raise isinstance(sm, SM) or Exception('Until takes a condition, a machine arguments and an optional name argument')
        self.name = name
        self.legalInputs = self.sm.legalInputs
        return
...
def splitValue(v, n = 2):
    ...
    if v == 'undefined':
        ...
        raise len(v) == n or AssertionError('Value wrong length')
        return v
