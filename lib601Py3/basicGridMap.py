# Embedded file name: /mit/6.01/mercurial/spring11/codeSandbox/lib601/basicGridMap.py
"""
...
class BasicGridMap(gridMap.GridMap):
    ...
    def __init__(self, worldPath, gridSquareSize, windowWidth = 400):
        ...
        gridMap.GridMap.__init__(self, 0, float(self.world.dimensions[0]), 0, float(self.world.dimensions[1]), gridSquareSize, windowWidth)
