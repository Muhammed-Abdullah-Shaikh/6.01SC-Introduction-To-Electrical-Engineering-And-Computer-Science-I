# Embedded file name: /mit/6.01/mercurial/spring11/codeSandbox/lib601/circ.py
"""
...
class Resistor(Component):
    ...
    def getEquation(self):
        return le.Equation([1.0, -1.0, -self.r], [self.n1, self.n2, self.current], 0)
...
class OpAmp(Component):
    ...
    def getEquation(self):
        return le.Equation([1.0, -self.K, self.K], [self.nOut, self.nPlus, self.nMinus], 0.0)
...
class Thevenin(Component):
    ...
    def getEquation(self):
        return le.Equation([1.0, -1.0, -self.r], [self.n1, self.n2, self.current], self.v)
