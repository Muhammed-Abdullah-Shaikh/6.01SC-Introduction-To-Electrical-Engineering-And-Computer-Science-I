# Embedded file name: /mit/6.01/mercurial/spring11/codeSandbox/lib601/dist.py
"""
...
class DDist:
    ...
    def __repr__(self):
        if len(list(self.d.items())) == 0:
            ...
            dictRepr = reduce(operator.add, [ util.prettyString(k) + ': ' + util.prettyString(p) + ', ' for k, p in list(self.d.items()) ])
