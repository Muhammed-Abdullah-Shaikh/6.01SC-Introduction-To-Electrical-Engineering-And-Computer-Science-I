# Embedded file name: /mit/6.01/mercurial/spring11/codeSandbox/lib601/idealReadings.py
"""
...
def computeIdealReadings(worldPath, xMin, xMax, y, numStates, numObs):
    ...
    for ix in range(numStates):
        readings.append(discreteSonarValue(idealSonarReading(util.Pose(x, y, 0), sonarDist.sonarPoses[0], world), numObs))
        x = x + xStep
