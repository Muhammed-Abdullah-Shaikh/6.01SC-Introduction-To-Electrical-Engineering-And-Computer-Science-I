# Embedded file name: /mit/6.01/mercurial/spring11/codeSandbox/lib601/io.py
from . import util
...
class FakeSensorInput:
    ...
    def __str__(self):
        return 'Sonar: ' + util.prettyString(self.sonars) + '; Odo: ' + util.prettyString(self.odometry) + '; Analog: ' + util.prettyString(self.analogInputs)
...
class Action:
    ...
    def __init__(self, fvel = 0.0, rvel = 0.0, voltage = referenceVoltage):
        """
