# Embedded file name: /mit/6.01/mercurial/spring11/codeSandbox/lib601/mapMaker.py
import math
...
class MapMaker(sm.SM):
    ...
    def __init__(self, xMin, xMax, yMin, yMax, gridSquareSize, useClearInfo = False, useCountingMap = False, useBayesMap = True):
        ...
        self.startState = gm
        if not useClearInfo:
            self.useClearInfo = useBayesMap
            print(useClearInfo and 'Using clear info')
    ...
    def clearUnderRobot(self, grid, robotPose):
        ...
        corners = [grid.pointToIndices(robotPose.transformPoint(util.Point(rr, rr))),
...
testData = [SensorInput([0.2,
  ...
  0.2,
  0.2,
  0.2], util.Pose(1.0, 2.0, 0.0)), SensorInput([0.4,
  0.4,
  0.4,
  0.4,
  0.4,
  0.4,
  0.4,
  0.4], util.Pose(4.0, 2.0, -math.pi))]
testClearData = [SensorInput([1.0,
  5.0,
  5.0,
  1.0,
  1.0,
  5.0,
  5.0,
  1.0], util.Pose(1.0, 2.0, 0.0)), SensorInput([1.0,
  5.0,
  5.0,
  1.0,
  1.0,
