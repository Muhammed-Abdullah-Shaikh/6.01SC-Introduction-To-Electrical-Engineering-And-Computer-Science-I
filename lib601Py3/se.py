# Embedded file name: /mit/6.01/mercurial/spring11/codeSandbox/lib601/se.py
"""
...
def makeStateEstimationSimulation(worldSM, verbose = False):
    ...
    """
    return sm.Cascade(sm.Parallel(worldSM, sm.Wire()), sm.Parallel(StateEstimator(worldSM, verbose=verbose), sm.Wire()))