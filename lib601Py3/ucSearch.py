# Embedded file name: /mit/6.01/mercurial/spring11/codeSandbox/lib601/ucSearch.py
"""
...
def search(initialState, goalTest, actions, successor, heuristic = lambda s: 0, maxNodes = 10000):
    """
...
def smSearch(smToSearch, initialState = None, goalTest = None, heuristic = lambda x: 0, maxNodes = 10000):
    """
    ...
    return search(initialState, goalTest, smToSearch.legalInputs, smToSearch.getNextValues, heuristic=heuristic, maxNodes=maxNodes)